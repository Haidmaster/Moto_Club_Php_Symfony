 ...
 */
final class Version20231110190755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE moto (id INT AUTO_INCREMENT NOT NULL, modele_id INT NOT NULL, immatriculation VARCHAR(32) NOT NULL, INDEX IDX_3DDDBCE4AC14B70A (modele_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
